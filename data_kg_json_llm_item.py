...
instruction = "针对时空场景的推荐问题，请总结出产品在时空场景的被推荐偏好包括：时间偏好，空间偏好，时空整体偏好，用户类型偏好，总体偏好，每个偏好用一句话描述，其中总体偏好是结合时间偏好，空间偏好，时空整体偏好和用户类型偏好形成的。此外，对于出现的时间信息需先分类成，早上，上午，中午，下午，傍晚，晚上，凌晨，工作日，节假日，法定节假日等多种细粒度的时间标签，对于空间信息区分开1km，3km，5km这类细粒度信息，然后用于推理总结偏好" 
